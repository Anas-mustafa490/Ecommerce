...
<div style="padding:32px; color:#374151;">
  ...
  <p style="font-size:15px; line-height:1.6; margin-top:12px;">Welcome to <strong>  ${process.env.WEBSITE_NAME}</strong>! Your account has been successfully created brotha.</p>
